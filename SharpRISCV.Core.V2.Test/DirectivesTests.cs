...
namespace SharpRISCV.Core.V2.Test
{
    ...
    public class DirectivesTests
    {
        ...
        {
            IToken textToken = new Token(TokenType.DIRECTIVE,".text",0,0);
        ...
        {
            IToken dataToken = new Token(TokenType.DIRECTIVE, ".data", 0, 0);
        ...
        public void IsText_ShouldReturnTrue_WhenTokenIsSection()
        {
            ...
            textToken = new Token(TokenType.DIRECTIVE, ".data", 0, 0);
        ...
        {
            IToken textToken = new Token(TokenType.DIRECTIVE, ".string", 0, 0);

            bool result = Directives.IsString(textToken);
            Assert.IsTrue(result);

            textToken = new Token(TokenType.DIRECTIVE, ".asciz", 0, 0);
        ...
        {
            IToken textToken = new Token(TokenType.DIRECTIVE, ".space", 0, 0);
